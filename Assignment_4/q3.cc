...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault("ns3::TcpSocket::SndBufSize", UintegerValue(29200000));
  Config::SetDefault("ns3::TcpSocket::RcvBufSize", UintegerValue(29200000));
  // Select TCP variant
...
Ipv4AddressHelper address2;
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Q3.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  //detailed trace of queue enq/deq packet tx/rx
  AsciiTraceHelper ascii;
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("Q3.tr"));
  pointToPoint.EnablePcapAll ("Q3");
