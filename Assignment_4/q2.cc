...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault("ns3::TcpSocket::SndBufSize", UintegerValue(20000000));
  Config::SetDefault("ns3::TcpSocket::RcvBufSize", UintegerValue(20000000));
  // Select TCP variant
...
Ipv4AddressHelper address2;
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Q2.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  //detailed trace of queue enq/deq packet tx/rx
  AsciiTraceHelper ascii;
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("Q2.tr"));
  pointToPoint.EnablePcapAll ("Q2");
